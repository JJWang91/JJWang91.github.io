import{b5 as e}from"./index-CeO2O4d3.js";import{p as z,o as K,l as $,i as q,t as Z,a as J,s as j,e as Q,c as ee,d as ae,b as ie,f as re}from"./oitFragment-BkMxmvKE.js";import{s as ne}from"./sceneUboDeclaration-BcGpapXf.js";import{a as fe,m as oe,l as te}from"./logDepthDeclaration-xlmrglt1.js";import{p as ce}from"./pbrUboDeclaration-LjvBWzaI.js";import{g as le,s as de,i as se,j as Ee,f as Re,d as Se,h as me,b as Ce,e as ue,a as ve,p as Ie,c as Ae}from"./pbrDebug-DoXoTdnf.js";import{s as pe,r as Ne}from"./reflectionFunction-q2qM80em.js";import{p as Oe,a as Te}from"./pbrIBLFunctions-DYdXoYdj.js";import{c as Le,a as _e}from"./clipPlaneFragment-D9Z4BXmb.js";import{f as Me,a as De}from"./fogFragment-aeJ-TADl.js";import{h as Fe}from"./helperFunctions-DGCjUq_S.js";import{h as ge}from"./harmonicsFunctions-DSz3RjdH.js";import{p as Pe}from"./pbrBRDFFunctions-CliS2h3t.js";import{a as he,b as Ue,c as be}from"./bumpFragment-BcIfUK_q.js";import{d as ye,l as Ge}from"./lightFragment-DdmgMYga.js";const i="samplerFragmentAlternateDeclaration",T=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=T);const Be={name:i,shader:T},r="pbrFragmentSamplersDeclaration",L=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=L);const Ve={name:r,shader:L},n="pbrBlockAlbedoOpacity",_=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=_);const We={name:n,shader:_},f="pbrBlockReflectivity",M=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=M);const He={name:f,shader:M},o="pbrBlockAmbientOcclusion",D=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=g);const Ye={name:c,shader:g},l="pbrBlockReflection",P=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=P);const ke={name:l,shader:P},d="pbrBlockSheen",h=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=h);const we={name:d,shader:h},s="pbrBlockClearcoat",U=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=U);const ze={name:s,shader:U},E="pbrBlockIridescence",b=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=b);const Ke={name:E,shader:b},R="pbrBlockSubSurface",y=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=y);const $e={name:R,shader:y},S="pbrBlockNormalFinal",G=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=G);const qe={name:S,shader:G},m="pbrBlockLightmapInit",B=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=B);const Ze={name:m,shader:B},C="pbrBlockGeometryInfo",V=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=W);const je={name:u,shader:W},v="pbrBlockDirectLighting",H=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=H);const Qe={name:v,shader:H},I="pbrBlockFinalLitComponents",x=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=x);const ea={name:I,shader:x},A="pbrBlockFinalUnlitComponents",X=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=X);const aa={name:A,shader:X},p="pbrBlockFinalColorComposition",Y=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=Y);const ia={name:p,shader:Y},N="pbrBlockPrePass",k=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=k);const ra={name:N,shader:k},O="pbrPixelShader",w=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[O]||(e.ShadersStoreWGSL[O]=w);const na=[z,K,ne,fe,ce,oe,le,$,pe,Be,Oe,Ve,q,Le,te,Me,Z,Fe,de,se,Ee,J,j,ge,Q,Re,Se,Pe,me,ee,Ce,ue,Te,he,Ue,Ne,ye,We,He,xe,Xe,Ye,ke,we,ze,Ke,$e,_e,ve,be,qe,ae,Ze,Je,je,Qe,Ge,ea,aa,ia,ie,De,Ie,ra,re,Ae];for(const a of na)e.IncludesShadersStoreWGSL[a.name]||(e.IncludesShadersStoreWGSL[a.name]=a.shader);const Aa={name:O,shader:w};export{Aa as pbrPixelShaderWGSL};
