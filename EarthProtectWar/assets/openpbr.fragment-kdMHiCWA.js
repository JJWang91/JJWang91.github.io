import{b5 as e}from"./index-CcDCXO3r.js";import{p as U,o as X,l as H,i as B,t as V,a as k,s as Y,e as Z,c as j,d as $,b as q,f as K}from"./oitFragment-DxDnM8RB.js";import{s as Q}from"./sceneUboDeclaration-vtUhy6kw.js";import{a as J,m as ee,l as re}from"./logDepthDeclaration-DyldAUH5.js";import{o as ae}from"./openpbrUboDeclaration-Dvc-8VjK.js";import{g as te,s as ie,i as ne,j as oe,f as fe,d as se,h as le,b as ce,e as _e,a as me,p as de,c as ue}from"./pbrDebug-BLC-aND4.js";import{s as pe,r as ge}from"./reflectionFunction-ByXuOJSP.js";import{p as ve,a as Ee}from"./pbrIBLFunctions-D2GTQQiL.js";import{c as Se,a as he}from"./clipPlaneFragment-Cr_8iVIj.js";import{f as Ie,a as Re}from"./fogFragment-f2lsZzcO.js";import{h as be}from"./helperFunctions-qO8LLG9x.js";import{h as Ne}from"./harmonicsFunctions-wulgghaa.js";import{p as Te}from"./pbrBRDFFunctions-DLObBC_h.js";import{o as Ae,a as Le,b as Fe,d as De,c as Oe}from"./openpbrTransmissionLayerData-hhQA7aWa.js";const a="openpbrFragmentSamplersDeclaration",I=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=I);const Ce={name:a,shader:I},t="openpbrNormalMapFragmentMainFunctions",R=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=R);const Pe={name:t,shader:R},i="openpbrNormalMapFragmentFunctions",b=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=b);const Ge={name:i,shader:b},n="openpbrConductorReflectance",N=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=N);const xe={name:n,shader:N},o="openpbrAmbientOcclusionFunctions",T=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=T);const Me={name:o,shader:T},f="openpbrVolumeFunctions",A=`struct OpenPBRHomogeneousVolume {extinction_coeff: vec3f, 
ss_albedo: vec3f, 
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=A);const ye={name:f,shader:A},s="openpbrNormalMapFragment",L=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=L);const We={name:s,shader:L},l="openpbrBlockNormalFinal",F=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=O);const Ue={name:_,shader:O},m="openpbrThinFilmLayerData",C=`#ifdef THIN_FILM
...
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=C);const Xe={name:m,shader:C},d="openpbrFuzzLayerData",P=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=P);const He={name:d,shader:P},u="openpbrAmbientOcclusionData",G=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=x);const Ve={name:p,shader:x},g="openpbrEnvironmentLighting",M=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=M);const ke={name:g,shader:M},v="openpbrDirectLightingInit",y=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=y);const Ye={name:v,shader:y},E="openpbrDirectLighting",W=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=W);const Ze={name:E,shader:W},S="openpbrBlockPrePass",z=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=z);const je={name:S,shader:z},h="openpbrPixelShader",w=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[h]||(e.ShadersStoreWGSL[h]=w);const $e=[U,X,Q,J,ae,ee,te,H,pe,ve,Ce,B,Se,re,Ie,V,be,ie,ne,oe,k,Y,Ne,Z,fe,se,Te,le,j,ce,_e,Ee,Pe,Ge,ge,Ae,xe,Me,Le,Fe,ye,he,me,We,ze,we,De,Oe,Ue,Xe,He,Be,$,Ve,ke,Ye,Ze,q,Re,de,je,K,ue];for(const r of $e)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const cr={name:h,shader:w};export{cr as openpbrPixelShaderWGSL};
