import{b5 as e}from"./index-CeO2O4d3.js";const t="decalFragmentDeclaration",p=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=p);const L={name:t,shader:p},o="prePassDeclaration",u=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=u);const A={name:o,shader:u},a="oitDeclaration",m=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=m);const I={name:a,shader:m},r="lightFragmentDeclaration",S=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=S);const M={name:r,shader:S},i="lightUboDeclaration",g=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=x);const _={name:s,shader:x},c="shadowsFragmentFunctions",w=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=w);const z={name:c,shader:w},l="imageProcessingDeclaration",D=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=D);const X={name:l,shader:D},v="imageProcessingFunctions",T=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=T);const b={name:v,shader:T},n="textureRepetitionFunctions",E=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=E);const U={name:n,shader:E},d="depthPrePass",C=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=C);const N={name:d,shader:C},f="logDepthFragment",y=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=y);const O={name:f,shader:y},h="oitFragment",P=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=P);const k={name:h,shader:P};export{N as a,b,R as c,L as d,O as e,_ as f,k as g,X as i,M as l,I as o,A as p,z as s,U as t};
