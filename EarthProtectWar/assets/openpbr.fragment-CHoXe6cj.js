import{b5 as e}from"./index-BE-hTyuV.js";import{p as H,o as B,d as V,l as k,c as Y,i as Z,t as $,b as j,s as q,f as K,a as Q,e as J,g as ee}from"./oitFragment-PW_uUzJF.js";import{s as ie,o as oe,a as re,b as te,d as ae,c as ne}from"./openpbrTransmissionLayerData-DhZGWJnc.js";import{s as se}from"./sceneUboDeclaration-DfqnmGlT.js";import{a as ce,m as le,l as fe}from"./logDepthDeclaration-DleR5vLP.js";import{o as _e}from"./openpbrUboDeclaration-DVyLsNnS.js";import{f as de,s as me,i as ue,g as ge,e as ve,c as Ee,h as pe,d as he,a as Re,p as Ie,b as Se}from"./pbrDebug-CL_0P48r.js";import{s as Te,r as Ae}from"./reflectionFunction-bDcFK9T9.js";import{p as be,a as Ne}from"./pbrIBLFunctions-BN8yLInM.js";import{a as Fe,c as Le}from"./clipPlaneFragment-CglWFS-r.js";import{a as Oe,f as Ce}from"./fogFragment-E3jsAHyV.js";import{h as De}from"./helperFunctions-BNmzQAD2.js";import{h as Pe}from"./harmonicsFunctions-X8TgNBk6.js";import{p as Me}from"./pbrBRDFFunctions-B3atJOmk.js";const o="openpbrFragmentDeclaration",S=`uniform float vBaseWeight;uniform vec4 vBaseColor;uniform float vBaseDiffuseRoughness;uniform vec4 vReflectanceInfo;uniform vec4 vSpecularColor;uniform vec3 vSpecularAnisotropy;uniform float vTransmissionWeight;uniform vec3 vTransmissionColor;uniform float vTransmissionDepth;uniform vec3 vTransmissionScatter;uniform float vTransmissionScatterAnisotropy;uniform float vTransmissionDispersionScale;uniform float vTransmissionDispersionAbbeNumber;uniform float vSubsurfaceWeight;uniform vec3 vSubsurfaceColor;uniform float vSubsurfaceRadius;uniform vec3 vSubsurfaceRadiusScale;uniform float vSubsurfaceScatterAnisotropy;uniform float vCoatWeight;uniform vec3 vCoatColor;uniform float vCoatRoughness;uniform float vCoatRoughnessAnisotropy;uniform float vCoatIor;uniform float vCoatDarkening;uniform float vFuzzWeight;uniform vec3 vFuzzColor;uniform float vFuzzRoughness;uniform vec2 vGeometryCoatTangent;uniform float vGeometryThickness;uniform vec3 vEmissionColor;uniform float vThinFilmWeight;uniform vec2 vThinFilmThickness;uniform float vThinFilmIor;uniform float vGeometryThinWalled;uniform vec4 vLightingIntensity;uniform float visibility;uniform vec2 renderTargetSize;
#ifdef BASE_COLOR
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=A);const ye={name:t,shader:A},a="openpbrNormalMapFragmentFunctions",b=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=b);const ze={name:a,shader:b},n="openpbrConductorReflectance",N=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=N);const Ue={name:n,shader:N},s="openpbrAmbientOcclusionFunctions",F=`float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=F);const We={name:s,shader:F},c="openpbrVolumeFunctions",L=`struct OpenPBRHomogeneousVolume {vec3 extinction_coeff; 
vec3 ss_albedo; 
...
weight_sum.b<1e-5f ? unconvolved_irradiance.b : irradiance_sum.b/weight_sum.b);}`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=L);const Xe={name:c,shader:L},l="openpbrNormalMapFragment",O=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=O);const we={name:l,shader:O},f="openpbrBlockNormalFinal",C=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=C);const He={name:f,shader:C},_="openpbrBaseLayerData",D=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=D);const Be={name:_,shader:D},d="openpbrCoatLayerData",P=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=x);const Ze={name:g,shader:x},v="openpbrBackgroundTransmission",y=`vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=y);const $e={name:v,shader:y},E="openpbrEnvironmentLighting",z=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=z);const je={name:E,shader:z},p="openpbrDirectLightingInit",U=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=U);const qe={name:p,shader:U},h="openpbrDirectLighting",W=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=W);const Ke={name:h,shader:W},R="openpbrBlockPrePass",X=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=X);const Qe={name:R,shader:X},I="openpbrPixelShader",w=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStore[I]||(e.ShadersStore[I]=w);const Je=[H,B,ie,V,Ge,se,ce,_e,le,de,k,Y,Te,be,xe,Z,Fe,fe,Oe,$,De,me,ue,ge,j,q,Pe,K,ve,Ee,Me,pe,he,Ne,ye,ze,Ae,oe,Ue,We,re,te,Xe,Le,Re,we,He,Be,ae,ne,Ve,ke,Ye,Ze,Q,$e,je,qe,Ke,J,Ce,Ie,Qe,ee,Se];for(const i of Je)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const ui={name:I,shader:w};export{ui as openpbrPixelShader};
