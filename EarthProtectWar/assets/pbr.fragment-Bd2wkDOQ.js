import{b5 as e}from"./index-BE-hTyuV.js";import{p as j,o as Q,d as ee,l as ie,c as ne,i as ae,t as re,b as fe,s as oe,f as te,a as ce,e as le,g as de}from"./oitFragment-PW_uUzJF.js";import{s as se}from"./sceneUboDeclaration-DfqnmGlT.js";import{a as Ee,m as Re,l as Ce}from"./logDepthDeclaration-DleR5vLP.js";import{p as Se}from"./pbrUboDeclaration-CpIaPIAj.js";import{f as ue,s as me,i as Ae,g as Ie,e as ve,c as Te,h as Ne,d as Oe,a as pe,p as Le,b as _e}from"./pbrDebug-CL_0P48r.js";import{s as De,r as Me}from"./reflectionFunction-bDcFK9T9.js";import{p as he,a as Fe}from"./pbrIBLFunctions-BN8yLInM.js";import{a as ge,c as Pe}from"./clipPlaneFragment-CglWFS-r.js";import{a as be,f as Ue}from"./fogFragment-E3jsAHyV.js";import{h as ye}from"./helperFunctions-BNmzQAD2.js";import{h as Be}from"./harmonicsFunctions-X8TgNBk6.js";import{p as Ge}from"./pbrBRDFFunctions-B3atJOmk.js";import{c as Ve,a as He,b as xe}from"./bumpFragment-D6EI5gSZ.js";import{d as Xe,c as We,l as Ye}from"./lightFragment-Do9szAMe.js";const n="pbrFragmentDeclaration",D=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=h);const Ke={name:r,shader:h},f="pbrBlockAlbedoOpacity",F=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=F);const ze={name:f,shader:F},o="pbrBlockReflectivity",g=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=g);const $e={name:o,shader:g},t="pbrBlockAmbientOcclusion",P=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=x);const ai={name:S,shader:x},u="pbrClusteredLightingFunctions",X=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=X);const ri={name:u,shader:X},m="pbrBlockNormalFinal",W=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=W);const fi={name:m,shader:W},A="pbrBlockLightmapInit",Y=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=Y);const oi={name:A,shader:Y},I="pbrBlockGeometryInfo",k=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
`;e.ShadersStore[_]||(e.ShadersStore[_]=J);const Ci=[j,Q,ee,ke,se,Ee,Se,Re,ue,ie,ne,De,we,he,Ke,ae,ge,Ce,be,re,ye,me,Ae,Ie,fe,oe,Be,te,ve,Te,Ge,Ne,Oe,Fe,Ve,He,Me,Xe,ze,$e,Ze,qe,Je,je,Qe,ei,ii,ni,We,ai,ri,Pe,pe,xe,fi,ce,oi,ti,ci,li,Ye,di,si,Ei,le,Ue,Le,Ri,de,_e];for(const i of Ci)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const Fi={name:_,shader:J};export{Fi as pbrPixelShader};
