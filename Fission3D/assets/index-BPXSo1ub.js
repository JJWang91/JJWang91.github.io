...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ln,depthTest:!1,depthWrite:!1})}function qo(){return new vn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:eo(),fragmentShader:`
		...
		`,blending:Ln,depthTest:!1,depthWrite:!1})}function $o(){return new vn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:eo(),fragmentShader:`
...
`)}function sm(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),e[a]={type:r.type,location:i.getAttribLocation(t,a),locationSize:o}}return e}function qi(i){return i!==""}function rl(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function al(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const rm=/^[ \t]*#include +<([\w\d./]+)>/gm;function Fa(i){return i.replace(rm,om)}const am=new Map;function om(i,t){let e=Ut[t];if(e===void 0){const n=am.get(t);if(n!==void 0)e=Ut[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Fa(e)}const lm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ol(i){return i.replace(lm,cm)}function cm(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function ll(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function hm(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Fl?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Nc?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===pn&&(t="SHADOWMAP_TYPE_VSM"),t}function um(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case wi:case Ai:t="ENVMAP_TYPE_CUBE";break;case sr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function dm(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Ai:t="ENVMAP_MODE_REFRACTION";break}return t}function fm(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Ol:t="ENVMAP_BLENDING_MULTIPLY";break;case th:t="ENVMAP_BLENDING_MIX";break;case eh:t="ENVMAP_BLENDING_ADD";break}return t}function pm(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function mm(i,t,e,n){const s=i.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=hm(e),c=um(e),h=dm(e),d=fm(e),f=pm(e),m=nm(e),g=im(r),x=s.createProgram();let p,u,T=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(qi).join(`
`)),a=Fa(a),a=rl(a,e),a=al(a,e),o=Fa(o),o=rl(o,e),o=al(o,e),a=ol(a),o=ol(o),e.isRawShaderMaterial!==!0&&(T=`#version 300 es
...
`)+`
`+u);const b=T+p+a,S=T+u+o,F=nl(s,s.VERTEX_SHADER,b),R=nl(s,s.FRAGMENT_SHADER,S);s.attachShader(x,F),s.attachShader(x,R),e.index0AttributeName!==void 0?s.bindAttribLocation(x,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function w(A){if(i.debug.checkShaderErrors){const k=s.getProgramInfoLog(x).trim(),B=s.getShaderInfoLog(F).trim(),X=s.getShaderInfoLog(R).trim();let j=!0,G=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(j=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,F,R);else{const J=sl(s,F,"vertex"),V=sl(s,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
void main() {
    ...
    `,document.head.appendChild(t)}}const se=i=>{const t=We.findIndex(e=>e.id===i);if(t<0)throw new Error(`未知方块 ${i}`);return t};function Ue(i,t){const e=new Set(t.map(([s,r])=>s+r*4)),n=[];for(let s=0;s<4;s++)for(let r=0;r<4;r++)e.has(r+s*4)||n.push({x:r,y:s,z:i,defIndex:(r+s+i)%4});return n}const $s=[{id:1,name:"初裂",target:1,hint:"底层缺中心 2×2，用 O 块补满触发 1 级裂变",prefill:Ue(0,[[1,1],[1,2],[2,1],[2,2]]),sequence:[se("O"),se("Dot"),se("Dot"),se("Dot")]},{id:2,name:"补角",target:1,hint:"底层缺 5 格：先用三连补直排，双块转向补 L 角",prefill:Ue(0,[[0,0],[1,0],[2,0],[3,0],[3,1]]),sequence:[se("I3"),se("I2"),se("Dot"),se("Dot")]},{id:3,name:"立壁",target:2,hint:"两层各缺同一处 1×2：把 O 块立起来，一次补满两层引发 2 级裂变",prefill:[...Ue(0,[[0,0],[1,0]]),...Ue(1,[[0,0],[1,0]])],sequence:[se("O"),se("Dot"),se("Dot"),se("Dot")]},{id:4,name:"接力",target:2,hint:"两层各缺同一排：两根双块立起 + O 立起，分三步贯穿补满两层",prefill:[...Ue(0,[[0,0],[1,0],[2,0],[3,0]]),...Ue(1,[[0,0],[1,0],[2,0],[3,0]])],sequence:[se("I2"),se("I2"),se("O"),se("Dot"),se("Dot")]},{id:5,name:"三连爆",target:3,hint:"三层各缺同一格：把三连立起来贯穿三层，引发 3 级裂变",prefill:[...Ue(0,[[2,2]]),...Ue(1,[[2,2]]),...Ue(2,[[2,2]])],sequence:[se("I3"),se("Dot"),se("Dot"),se("Dot")]},{id:6,name:"全裂",target:4,hint:"四层各缺同一格：把 I 杆立起来贯穿四层，引发 4 级全裂",prefill:[...Ue(0,[[1,1]]),...Ue(1,[[1,1]]),...Ue(2,[[1,1]]),...Ue(3,[[1,1]])],sequence:[se("I"),se("Dot"),se("Dot"),se("Dot")]}],Yr={mode:"classic",well:"standard",solids:!0,volume:.9,puzzleLevel:1},Mc="fission3d.settings",yc="fission3d.best",Sc="fission3d.puzzleStars",Vg=["classic","zen","puzzle","daily"];function Gg(){try{const i=localStorage.getItem(Mc);if(!i)return{...Yr};const t=JSON.parse(i);return{mode:Vg.includes(t.mode)?t.mode:"classic",well:t.well==="challenge"?"challenge":"standard",solids:t.solids!==!1,volume:typeof t.volume=="number"?Math.min(1,Math.max(0,t.volume)):Yr.volume,puzzleLevel:Math.min(6,Math.max(1,Math.floor(Number(t.puzzleLevel))||1))}}catch{return{...Yr}}}function Ul(i){try{localStorage.setItem(Mc,JSON.stringify(i))}catch{}}function Va(i,t){try{return Number(localStorage.getItem(`${yc}.${i}.${t}`))||0}catch{return 0}}function Wg(i,t,e){try{localStorage.setItem(`${yc}.${i}.${t}`,String(e))}catch{}}function nr(i=new Date){const t=e=>String(e).padStart(2,"0");return`${i.getFullYear()}-${t(i.getMonth()+1)}-${t(i.getDate())}`}function Ga(i){try{return Number(localStorage.getItem(`${Sc}.${i}`))||0}catch{return 0}}function Xg(i,t){try{localStorage.setItem(`${Sc}.${i}`,String(t))}catch{}}const Yg=[{key:"classic",desc:"标准规则，持续加速"},{key:"zen",desc:"不加速，放松游玩"},{key:"puzzle",desc:"残局闯关，限定步数"},{key:"daily",desc:"全玩家同序列，冲每日最高"}];class qg{constructor(t,e){W(this,"root");W(this,"bestEl");W(this,"puzzleSeg");W(this,"settings");this.actions=t,this.settings={...e},this.injectStyle(),this.root=Rt("div","menu");const n=Rt("div","menu-box");n.appendChild(Rt("h1","menu-title","核之裂变"));const s=Rt("div","menu-sub");s.innerHTML="FISSION<span>3D</span>",n.appendChild(s);const r=Rt("div","m-row");r.appendChild(Rt("span","m-label","模式"));const a=Rt("div","seg");a.dataset.key="mode";for(const m of Yg){const g=Rt("button","seg-btn");g.innerHTML=`${ka[m.key]}<i>${m.desc}</i>`,g.dataset.value=m.key,g.addEventListener("click",()=>{this.settings.mode=m.key,this.saveAndRefresh()}),a.appendChild(g)}r.appendChild(a),n.appendChild(r);const o=Rt("div","m-row");o.dataset.row="puzzle",o.appendChild(Rt("span","m-label","关卡")),this.puzzleSeg=Rt("div","seg"),this.puzzleSeg.dataset.key="puzzleLevel";for(const m of $s){const g=Rt("button","seg-btn lv");g.dataset.value=String(m.id),g.addEventListener("click",()=>{this.settings.puzzleLevel=m.id,this.saveAndRefresh()}),this.puzzleSeg.appendChild(g)}o.appendChild(this.puzzleSeg),n.appendChild(o);const l=this.buildSeg("井尺寸","well",[{value:"standard",label:`${je.standard.X}×${je.standard.Y}×${je.standard.Z}`},{value:"challenge",label:`${je.challenge.X}×${je.challenge.Y}×${je.challenge.Z}（高手）`}]);l.dataset.row="well",n.appendChild(l);const c=this.buildSeg("方块组","solids",[{value:"1",label:"标准（全部）"},{value:"0",label:"新手（仅平面）"}]);c.dataset.row="solids",n.appendChild(c);const h=Rt("div","m-row");h.appendChild(Rt("span","m-label","音量"));const d=document.createElement("input");d.type="range",d.min="0",d.max="100",d.value=String(Math.round(this.settings.volume*100)),d.addEventListener("input",()=>{this.settings.volume=Number(d.value)/100,Ul(this.settings),this.actions.onVolume(this.settings.volume)}),h.appendChild(d),n.appendChild(h),this.bestEl=Rt("div","menu-best"),n.appendChild(this.bestEl);const f=Rt("button","menu-start","开始游戏");f.addEventListener("click",()=>this.actions.onStart(this.settings)),n.appendChild(f),this.root.appendChild(n),document.body.appendChild(this.root),this.refresh()}show(){this.root.style.display="flex",this.refresh()}hide(){this.root.style.display="none"}buildSeg(t,e,n){const s=Rt("div","m-row");s.appendChild(Rt("span","m-label",t));const r=Rt("div","seg");r.dataset.key=e;for(const a of n){const o=Rt("button","seg-btn",a.label);o.dataset.value=a.value,o.addEventListener("click",()=>{e==="well"?this.settings.well=a.value:this.settings.solids=a.value==="1",this.saveAndRefresh()}),r.appendChild(o)}return s.appendChild(r),s}saveAndRefresh(){Ul(this.settings),this.refresh()}refresh(){const t=this.settings,e=t.mode==="puzzle",n=e||t.mode==="daily";for(const s of this.root.querySelectorAll(".seg")){const r=s.dataset.key,a=r==="mode"?t.mode:r==="puzzleLevel"?String(t.puzzleLevel):r==="well"?t.well:String(Number(t.solids));for(const o of s.querySelectorAll(".seg-btn"))o.classList.toggle("on",o.dataset.value===a)}for(const s of this.root.querySelectorAll(".m-row[data-row]")){const a=s.dataset.row==="puzzle"?!e:n;s.classList.toggle("off",a)}for(const s of $s){const r=this.puzzleSeg.querySelector(`[data-value="${s.id}"]`);r&&(r.innerHTML=`${s.id} ${s.name}<i>${Ha(Ga(s.id))}</i>`)}if(e){const s=$s[t.puzzleLevel-1];this.bestEl.innerHTML=`益智挑战 · 第 ${s.id} 关 ${s.name} · 最高评价 <b>${Ha(Ga(s.id))}</b>`}else if(t.mode==="daily")this.bestEl.innerHTML=`每日挑战 · ${nr()} 今日最高分 <b>${Va("daily",nr())}</b>`;else{const s=je[t.well];this.bestEl.innerHTML=`${ka[t.mode]} · ${s.X}×${s.Y}×${s.Z} 本地最高分 <b>${Va(t.mode,t.well)}</b>`}}injectStyle(){const t=document.createElement("style");t.textContent=`
